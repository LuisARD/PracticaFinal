        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Tiendas alrededor del pais: </h1>
                    <hr class="divider" />
                </div>
...
try {
    ...
    $results = $gestorDB->getTiendas();

    // Mostrar los resultados
    echo "<table border='1'>";
    echo "<tr><th>Nombre</th><th>Direccion</th><th>Ciudad</th><th>Pais</th><th>Codigo Postal</th></tr>";
    foreach ($results as $row) {
        echo "<tr>";
        echo "<td>".$row['nombre_tienda']."</td>";
        echo "<td>".$row['direcc_tienda']."</td>";
